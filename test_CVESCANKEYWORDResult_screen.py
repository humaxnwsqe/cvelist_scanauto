...
class TestCVESCANKEYWORDRESULT_screen():
    ...
    def test_cVESCANKEYUPnP(self, browser):
        ...
        #time.sleep(3)
        #browser.find_element(By.CSS_SELECTOR, ".smaller:nth-child(2)").click()
        # 7 | assertText | css=.smaller:nth-child(2) | There are 115 CVE entries that match your search. | 
        time.sleep(3)
        assert browser.find_element(By.CSS_SELECTOR, ".smaller:nth-child(2)").text == "There are 115 CVE entries that match your search."
        #assert False
        # 8 | close |  |  | 
        #browser.close()
