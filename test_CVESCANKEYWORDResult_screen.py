...
class TestCVESCANKEYWORDRESULT_screen():
    ...
    def test_cVESCANKEYbroadcom(self, browser):
        ...
        #time.sleep(3)
        #browser.find_element(By.CSS_SELECTOR, ".smaller:nth-child(2)").click()
        # 7 | assertText | css=.smaller:nth-child(2) | There are 86 CVE entries that match your search. | 
        time.sleep(10)
        assert browser.find_element(By.CSS_SELECTOR, ".smaller:nth-child(2)").text == "There are 86 CVE Records that match your search."
        #assert False
        # 8 | close |  |  | 
        #browser.close()
    ...
    def test_cVESCANKEYUPnP(self, browser):
        ...
        #time.sleep(3)
        #browser.find_element(By.CSS_SELECTOR, ".smaller:nth-child(2)").click()
        # 7 | assertText | css=.smaller:nth-child(2) | There are 126 CVE entries that match your search. | 
        time.sleep(10)
        assert browser.find_element(By.CSS_SELECTOR, ".smaller:nth-child(2)").text == "There are 126 CVE Records that match your search."
        #assert False
        # 8 | close |  |  | 
        #browser.close()
